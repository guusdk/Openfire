...
public class SessionManagerCloseListenerRouteOwnershipTest
{
    ...
    /**
     * Reflectively invoke the private client close listener for the given session.
     */
    private void fireConnectionClose(final LocalClientSession session) throws Exception
    {
        ...
        final Method method = listener.getClass().getDeclaredMethod("onConnectionClose", Object.class);   // 4.x sync variant
